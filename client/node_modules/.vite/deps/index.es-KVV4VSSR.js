...
var require_require_object_coercible = __commonJS({
  "node_modules/core-js/internals/require-object-coercible.js"(exports, module) {
    ...
    module.exports = function(it) {
      if (isNullOrUndefined4(it)) throw $TypeError("Can't call method on " + it);
      return it;
    };
  }
});
...
var require_classof = __commonJS({
  "node_modules/core-js/internals/classof.js"(exports, module) {
    ...
    module.exports = TO_STRING_TAG_SUPPORT ? classofRaw : function(it) {
      var O2, tag, result;
      return it === void 0 ? "Undefined" : it === null ? "Null" : typeof (tag = tryGet(O2 = $Object(it), TO_STRING_TAG2)) == "string" ? tag : CORRECT_ARGUMENTS ? classofRaw(O2) : (result = classofRaw(O2)) == "Object" && isCallable2(O2.callee) ? "Arguments" : result;
    };
  }
});
...
var require_regexp_exec_abstract = __commonJS({
  "node_modules/core-js/internals/regexp-exec-abstract.js"(exports, module) {
    ...
    module.exports = function(R, S) {
      ...
      if (classof(R) === "RegExp") return call4(regexpExec2, R, S);
    ...
    module.exports = function(Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED3) {
      ...
      if (anyNativeIterator) {
        ...
        if (CurrentIteratorPrototype !== Object.prototype && CurrentIteratorPrototype.next) {
          ...
          if (IS_PURE3) Iterators[TO_STRING_TAG2] = returnThis;
        }
      }
...
var require_es_array_iterator = __commonJS({
  "node_modules/core-js/modules/es.array.iterator.js"(exports, module) {
    ...
    module.exports = defineIterator(Array, "Array", function(iterated, kind) {
      ...
      if (kind == "keys") return createIterResultObject(index2, false);
      if (kind == "values") return createIterResultObject(target[index2], false);
...
var require_array_slice_simple = __commonJS({
  "node_modules/core-js/internals/array-slice-simple.js"(exports, module) {
    ...
    module.exports = function(O2, start, end) {
      ...
      for (var n2 = 0; k < fin; k++, n2++) createProperty(result, n2, O2[k]);
      result.length = n2;
      return result;
    };
  }
    ...
    internalSplit = function(separator, limit) {
      ...
      while (match = call3(regexpExec, separatorCopy, string)) {
        ...
        if (lastIndex > lastLastIndex) {
          ...
          if (match.length > 1 && match.index < string.length) apply2($push, output, arraySlice(match, 1));
      ...
      if (lastLastIndex === string.length) {
        if (lastLength || !exec(separatorCopy, "")) push2(output, "");
      } else push2(output, stringSlice3(string, lastLastIndex));
...
svg-pathdata/lib/SVGPathData.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=index.es-KVV4VSSR.js.map
